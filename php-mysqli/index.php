                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($foto) { ?>
                                <div class="mt-2">
                                    <img src="images/<?php echo $foto ?>" alt="Foto Mahasiswa" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td scope="row">
                                    <?php if($foto) { ?>
                                        <img src="images/<?php echo $foto ?>" alt="Foto" style="width: 50px; height: 50px; object-fit: cover; border-radius: 5px;">
                                    <?php } else { ?>
